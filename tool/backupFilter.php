...
if ($filterObjectClass!='Planning' and $filterObjectClass!='GlobalPlanning' and $filterObjectClass!='VersionsPlanning' and substr($filterObjectClass,0,7)!='Report_') Security::checkValidClass($filterObjectClass);
